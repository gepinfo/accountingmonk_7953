...
{ path : '/logins', component: lazy(()=>import('./app/logins/logins')) },
{ path : '/signups', component: lazy(()=>import('./app/signups/signups')) },
{ path : '/dashboard', component: lazy(()=>import('./app/dashboard/dashboard')) },
{ path : '/report', component: lazy(()=>import('./app/report/report')) },
{ path : '/updateaccount', component: lazy(()=>import('./app/updateaccount/updateaccount')) },
{ path : '/createentries', component: lazy(()=>import('./app/createentries/createentries')) },
{ path : '/generalledger', component: lazy(()=>import('./app/generalledger/generalledger')) },
